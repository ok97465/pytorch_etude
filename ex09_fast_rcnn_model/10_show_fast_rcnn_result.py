...
# %% Parameter
path_model_ckpt = (
    "./logs/fast_rcnn_model_bus_truck/220529_123330_ver0.001/checkpoint/"
    "epoch=20-valid_acc=0.74.ckpt"
)
...
for sample in iter(data.train_dataloader()):
    # Fowarding
    with no_grad():
        scores, deltas = model(sample["img"], sample["box_coordinates_resized"])
    ...
    box_bus_truck = sample["box_ratio"][0][idx_bus_truck] * ratio2coordi
